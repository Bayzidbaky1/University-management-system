                                    ...
                                    <form action="index.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        <div class="card-body">
                                            <div class="form-group row ">
                                                <label for="index_number" class="col-sm-2 col-form-label ">ID</label>
                                                <div class="col-sm-10" id="divIndexNumber">
                                                    <input type="text" class="form-control " placeholder="Enter id" id="index_number" name="index_number">
